# Evidencias
Aquí se encontrarán mis evidencias del desarrollo y despliegue del proyecto.
...
👉 **[Enlace a mi página desplegada](https://emi-ing04.github.io/Proyecto-final-JEGM-3-WEB-A/)**
...
* [EsUtilicé etiquetas como `<header>`, `<main>`, `<section>` y `<footer>`. Las usé porque permiten estructurar el contenido de forma lógica, lo cual es buena práctica para mejorar la accesibilidad de la página y hacer el código más fácil de leer".]
